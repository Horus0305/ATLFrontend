...
export const API_URLS = {
  ...
  getTestScopes: `${API_BASE_URL}/test-scope`,
  createTestScope: `${API_BASE_URL}/test-scope`,
  updateTestScope: (id) => `${API_BASE_URL}/test-scope/${id}`,
  deleteTestScope: (id) => `${API_BASE_URL}/test-scope/${id}`,
